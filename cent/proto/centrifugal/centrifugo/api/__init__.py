...
# sources: cent/proto/apiproto.proto
...
class Command(betterproto.Message):
    ...
    invalidate_user_tokens: "InvalidateUserTokensRequest" = betterproto.message_field(
        24
    )
    ...
    send_push_notification: "SendPushNotificationRequest" = betterproto.message_field(
        33
    )
...
class CentrifugoApiBase(ServiceBase):
    ...
    async def broadcast(
        self, broadcast_request: "BroadcastRequest"
    ) -> "BroadcastResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def block_user(
        self, block_user_request: "BlockUserRequest"
    ) -> "BlockUserResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def device_list(
        self, device_list_request: "DeviceListRequest"
    ) -> "DeviceListResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def cancel_push(
        self, cancel_push_request: "CancelPushRequest"
    ) -> "CancelPushResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
